...
$pemasok=tampil("SELECT * FROM pemasok WHERE id_pemasok=$id")[0];

//codingan simpan data
if(isset($_POST["update_pemasok"]) ){
    if(update_pemasok($_POST) > 0){
        echo"
        <script>
                         ...
                         <div class="card mb-4">
                            ...
                            <div class="card-body">
                               <form action="" method="post">
                                    <input type="hidden" name="id_pemasok" value="<?php echo $pemasok["id_pemasok"];?>">
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Nama Pemasok</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="nama_pemasok" autocomplete="off" value="<?php echo $pemasok["nama_pemasok"] ?>">    
                            </div>
                        <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Telepon</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="telepon" autocomplete="off" value="<?php echo $pemasok["telepon_pemasok"] ?>">    
                            </div>
 <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Alamat</label>
                                <input type="text" class="form-control" id="exampleInputPassword1" name="alamat_pemasok" autocomplete="off" value="<?php echo $pemasok["alamat_pemasok"] ?>">    
                            </div>
                       
                             <button type="submit" class="btn btn-primary mt-3" name="update_pemasok">Update</button>
                          </div>
                      </form>
