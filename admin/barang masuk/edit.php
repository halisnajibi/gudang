...
$bm=tampil("SELECT * FROM brg_masuk WHERE id_bm=$id")[0];

//codingan simpan data
if(isset($_POST["update_masuk"]) ){
    if(update_masuk($_POST) > 0){
        echo"
        <script>
                         ...
                         <div class="card mb-4">
                            ...
                            <div class="card-body">
                               <form action="" method="post">
                                    <input type="hidden" name="id_bm" value="<?php echo $bm["id_bm"];?>">
                     
                         <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Keterangan</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="keterangan_masuk" autocomplete="off" value="<?php echo $bm["keterangan_masuk"] ?>"> 
                             <button type="submit" class="btn btn-primary mt-3" name="update_masuk">Update</button>
                          </div>
                      </form>
