            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h3 class="mt-4">Table Karyawan</h3>
                                ...
                                <table id="datatablesSimple" class="table table-striped" >
                                    ...
                                    <tbody>
                                        <tr>   <?php $i=1; ?>
                                            ...
                                            <td> 
                                            <a href="edit.php?id_karyawan=<?php echo $data["id_karyawan"] ?>" 
                                            "><button type="submit" name="edit" class="btn btn-warning">Edit</button> </a>
                                            <a href="hapus.php?id_karyawan=<?php echo $data["id_karyawan"] ?>" onclick="return confirm('anda yakin untuk menghapus')
