                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="../suplier/view.php">Suplier</a>
                                     <a class="nav-link" href="view.php">Satuan</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h3 class="mt-4">Table Satuan Barang</h3>
                                ...
                                <table id="datatablesSimple" class="table table-striped" >
                                    ...
                                    <tbody>
                                        <tr>   <?php $i=1; ?>
                                            ...
                                            <a href="hapus.php?id_satuan=<?php echo $data["id_satuan"] ?>" onclick="return confirm('anda yakin untuk menghapus')
